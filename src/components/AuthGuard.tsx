...
const NAV_ITEMS: { href: string; label: string; d: string; d2?: string }[] = [
    ...
    { href: "/templates", label: "Templates", d: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" },
    { href: "/sequences", label: "Sequences", d: "M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 00-3.7-3.7 48.678 48.678 0 00-7.324 0 4.006 4.006 0 00-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3l-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 003.7 3.7 48.656 48.656 0 007.324 0 4.006 4.006 0 003.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3l-3 3" },
];
...
export function AppHeader() {
    ...
    const menuItems = [
        {
            icon: <Icon d="M21.75 17.25v-.228a4.328 4.328 0 00-.745-2.437 6.533 6.533 0 00-4.131-2.764m0 0a3.188 3.188 0 00-.581-.13 3 3 0 10-2.036 5.456c.14.059.286.106.436.14m2.181-5.466a43.172 43.172 0 00-7.874 0c-2.197.192-3.901 1.972-4.085 4.173M15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />,
            label: "Email Accounts",
            onClick: () => { router.push("/accounts"); setShowUserMenu(false); },
        },
        {
    ...
    return (
        <>
            ...
            {/* Mobile Bottom Navigation — 5 core items */}

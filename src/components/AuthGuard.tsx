...
const NAV_ITEMS = [
    ...
    { href: "/scraper", label: "Leads", d: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z", badge: "Soon" },
                        ...
                        <nav className="flex items-center gap-1">
                            {NAV_ITEMS.slice(0, 4).map((item) => (
                                ...
                                >
                                    ...
                                    {(item as any).badge && (
                                        <span className="hidden lg:inline-flex px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-amber-100 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 rounded-full leading-none">
                                            {(item as any).badge}
                                        </span>
                                    )}
                                </Link>
                ...
                <div className="flex items-center justify-around py-2 px-1">
                    {NAV_ITEMS.slice(0, 4).map((item) => (
                        ...
                        >
                            ...
                            {(item as any).badge && (
                                <span className="absolute -top-0.5 -right-0.5 px-1 py-px text-[7px] font-bold uppercase bg-amber-400 text-amber-900 rounded-full leading-none">
                                    {(item as any).badge}
                                </span>
                            )}
                        </Link>

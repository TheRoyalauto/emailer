    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white">
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <nav className="flex gap-4">
                            ...
                            <Link href="/templates" className="text-white/60 hover:text-white transition-colors">Templates</Link>
                            <Link href="/contacts" className="text-white/60 hover:text-white transition-colors">Contacts</Link>
                            <Link href="/senders" className="text-white font-medium">Senders</Link>
                        </nav>
                    </div>
                    <button
            ...
            <main className="max-w-7xl mx-auto px-6 py-8">
                <h1 className="text-3xl font-bold mb-8">Sender Identities</h1>

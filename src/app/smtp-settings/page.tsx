        ...
        <div className="min-h-screen bg-slate-50 pb-20 md:pb-0">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-slate-500 mt-1">Configure email sending credentials</p>
                    </div>
                    <button
                ...
                {configs === undefined ? (
                    ...
                    <div className="text-center py-16 bg-white rounded-xl border border-slate-200">
                        ...
                        <p className="text-slate-500 mb-4">Add your email credentials to start sending</p>
                        <button
                            onClick={() => setShowAdd(true)}
                    ...
                    <div className="space-y-4">
                        {configs.map((config) => (
                            <div
                                key={config._id}
                                className={`bg-white rounded-xl border p-5 ${config.isDefault ? "border-indigo-500/50" : "border-slate-200"
                                    }`}
                            >
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="px-3 py-1.5 bg-white hover:bg-slate-50 text-slate-500 rounded-lg text-sm transition-colors"
                                        >
            ...
            {showAdd && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl border border-slate-200 w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                        <h2 className="text-xl font-bold mb-4">Add SMTP Configuration</h2>

                        <div className="space-y-4">
                            {/* Preset Selector */}
                            <div>
                                <label className="text-sm text-slate-500 mb-1 block">Email Provider</label>
                                <select
                                    value={preset}
                            ...
                            {preset === "Custom" && (
                                <>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-sm text-slate-500 mb-1 block">Host</label>
                                            <input
                                                type="text"
                                                value={host}
                                        ...
                                        <div>
                                            <label className="text-sm text-slate-500 mb-1 block">Port</label>
                                            <input
                                                type="number"
                                                value={port}
                                    ...
                                    <label className="flex items-center gap-2">
                                        ...
                                        />
                                        <span className="text-sm text-slate-500">Use SSL (port 465)</span>
                                    </label>
                                </>
                            )}

                            <div>
                                <label className="text-sm text-slate-500 mb-1 block">Email / Username</label>
                                <input
                                    type="email"
                                    value={username}
                                    onChange={(e) => {
                            ...
                            <div>
                                <label className="text-sm text-slate-500 mb-1 block">From Email</label>
                                <input
                                    type="email"
                                    value={fromEmail}
                            ...
                            <div>
                                <label className="text-sm text-slate-500 mb-1 block">From Name (optional)</label>
                                <input
                                    type="text"
                                    value={fromName}
                            ...
                            <label className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-4 h-4 rounded"
                                />
                                <span className="text-sm text-slate-500">Set as default for sending</span>
                            </label>
                        </div>

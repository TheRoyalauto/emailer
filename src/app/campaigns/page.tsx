...
export default function CampaignsPage() {
    const [activeTab, setActiveTab] = useState<"new" | "replies">("new");
            ...
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20 md:pb-0">
                ...
                <main className="max-w-4xl mx-auto px-6 py-8">
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold font-heading text-slate-900 dark:text-white tracking-[-0.03em]">Campaigns</h1>
                            <p className="text-slate-400 mt-1">Manage your outreach campaigns and inbound replies</p>
                        </div>
                    </div>

                    {/* Tabs */}
                    <div className="flex items-center gap-1 bg-slate-200/50 dark:bg-slate-800/50 p-1 rounded-xl w-fit mb-8">
                        <button
                            onClick={() => setActiveTab("new")}
                            className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all ${activeTab === "new"
                        ...
                        <button
                            ...
                            className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all ${activeTab === "replies"
                                    ? "bg-white dark:bg-slate-900 text-cyan-600 dark:text-cyan-400 shadow-sm"
                                    : "text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200"
                                }`}
                        >
                ...
                <ErrorBoundary
                    fallback={
                        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 max-w-md w-full text-center shadow-2xl">
                                ...
                                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Campaign Error</h3>
                                <p className="text-sm text-slate-400 mb-6">Something went wrong loading the campaign sender. Please try again.</p>
                                <button
                                    onClick={() => setShowSendModal(false)}
                                    className="px-5 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg text-sm font-semibold hover:bg-slate-800 dark:hover:bg-slate-100 transition-all"
                                >
                                    Close
                                </button>
                            </div>

            ...
            <main className="max-w-6xl mx-auto px-4 py-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-white/50 text-sm">Configure voice, tone, and content rules for AI-generated emails</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <label className="text-sm text-white/70">Set as default</label>
                                </div>
                                ...
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">Sender Persona</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">Voice Description</label>
                                    <textarea
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm text-white/70 mb-1">Max Paragraphs</label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="block text-sm text-white/70 mb-1">Max Subject Length</label>
                                        <input
                                            type="number"
                                ...
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">Signature Template</label>
                                    <textarea
                            ...
                            <div className="space-y-4">
                                {/* Voice Samples */}
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">Voice Samples</label>
                                    <p className="text-xs text-white/40 mb-2">Example emails that match your brand voice</p>
                                    <div className="flex gap-2 mb-2">
                                        <textarea
                                            ...
                                            rows={2}
                                            className="flex-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/30 resize-none text-sm"
                                        />
                                        <button
                                    ...
                                    <div className="space-y-1 max-h-24 overflow-y-auto">
                                        {formData.voiceSamples.map((sample, i) => (
                                            <div key={i} className="flex items-center gap-2 bg-white/5 rounded px-2 py-1">
                                                <span className="text-xs text-white/70 flex-1 truncate">{sample.slice(0, 50)}...</span>
                                ...
                                {/* Forbidden Phrases */}
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">🚫 Forbidden Phrases</label>
                                    <div className="flex gap-2 mb-2">
                                        <input
                                            type="text"
                                            value={newForbidden}
                                ...
                                {/* Required Phrases */}
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">✓ Required Phrases</label>
                                    <div className="flex gap-2 mb-2">
                                        <input
                                            type="text"
                                            value={newRequired}
                                ...
                                {/* Preferred Phrases */}
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">★ Preferred Phrases</label>
                                    <div className="flex gap-2 mb-2">
                                        <input
                                            type="text"
                                            value={newPreferred}
                                ...
                                {/* Product Facts */}
                                <div>
                                    <label className="block text-sm text-white/70 mb-1">📋 Product Facts</label>
                                    <p className="text-xs text-white/40 mb-2">Key facts AI should know about your product</p>
                                    <div className="flex gap-2 mb-2">
                                        <input
                                            type="text"
                                            value={newFact.fact}
                                    ...
                                    <div className="space-y-1 max-h-24 overflow-y-auto">
                                        {formData.productFacts.map((fact, i) => (
                                            <div key={i} className="flex items-center gap-2 bg-amber-500/10 rounded px-2 py-1">
                                                ...
                                                {fact.context && <span className="text-xs text-white/50">({fact.context})</span>}
                    ...
                    <div className="grid gap-4">
                        {rules?.length === 0 && (
                            <div className="bg-[#12121a] border border-white/10 rounded-xl p-12 text-center">
                                ...
                                <p className="text-white/50 text-sm mb-4">Create your first brand rule to guide AI-generated content</p>
                                <button
                                    onClick={() => setIsCreating(true)}
                                    className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg font-medium transition-all"
                                >
                        ...
                        {rules?.map((rule) => (
                            <div key={rule._id} className="bg-[#12121a] border border-white/10 rounded-xl p-5 hover:border-white/20 transition-all">
                                ...
                                {rule.voiceDescription && (
                                    <p className="text-white/60 text-sm mb-3">{rule.voiceDescription}</p>
                                )}

...
function TasksContent() {
    ...
    return (
        <PageWrapper maxWidth="7xl">
            <PageHeader
                title="Tasks"
                subtitle="Manage follow-ups, reminders, and to-dos"
            >
            ...
            <StatsBar items={[
                { value: stats?.total || 0, label: "Active" },
                { value: stats?.pending || 0, label: "Pending", color: "text-amber-400" },
                { value: stats?.inProgress || 0, label: "In Progress", color: "text-blue-400" },
                { value: stats?.overdue || 0, label: "Overdue", color: "text-red-400" },
                { value: stats?.completedToday || 0, label: "Done Today", color: "text-emerald-400" },
            ]} />

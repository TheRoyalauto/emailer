    ...
    return (
        <PageWrapper maxWidth="7xl">
            <StatsBar items={[
                ...
                { value: stats?.pending || 0, label: "Pending Response", color: "text-blue-400" },
                { value: stats?.responded || 0, label: "Responded", color: "text-green-400" },
                { value: stats?.averageSentiment || 0, label: "Avg Sentiment", style: { color: stats?.averageSentiment && stats.averageSentiment > 0 ? "#22c55e" : stats?.averageSentiment && stats.averageSentiment < 0 ? "#ef4444" : "#9ca3af" } },
            ]} />
